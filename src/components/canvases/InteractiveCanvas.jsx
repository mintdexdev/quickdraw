...
// functionality
import { nearPoint, getRandomSeed } from '@engine/math'
import { onCorner, onRectangle, onLine, onEllipse } from '@engine/mouseOnShape'
import { createElement, updateElement } from '@engine/elementRelated';
...
const InteractiveCanvas = forwardRef(({ canvasSize, pressedKeys }, ref) => {
  const { strokeColor, strokeWidth, roughness, fillColor } = useOptionsStore();
